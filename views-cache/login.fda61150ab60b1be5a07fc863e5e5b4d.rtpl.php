...
<head>
  ...
  <title>AdminBiju | Conecte-se</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="/res/admin/index2.html"><b>Admin</b>Biju</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form action="/admin/login" method="post">
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit" class="btn btn-primary btn-block btn-flat">Assinar em</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
